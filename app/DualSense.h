...
namespace Trigger {
    enum TriggerMode : uint8_t {
        Off = 0x0, Rigid = 0x1, Pulse = 0x2, Rigid_A = 0x1 | 0x20, Rigid_B = 0x1 | 0x04, Rigid_AB = 0x1 | 0x20 | 0x04,
        Pulse_A = 0x2 | 0x20, Pulse_A2 = 35, Pulse_B = 0x2 | 0x04, Pulse_B2 = 38, Pulse_AB = 39, Calibration = 0xFC,
        Feedback = 0x21, Weapon = 0x25, Vibration = 0x26
    };
}

namespace DualsenseUtils {
    enum HapticFeedbackStatus { Working = 0, BluetoothNotUSB = 1, AudioDeviceNotFound = 2, AudioEngineNotInitialized = 3, Unknown = 4 };
...
public:
    ...
    void SetRightTrigger(Trigger::TriggerMode triggerMode, uint8_t Force1, uint8_t Force2, uint8_t Force3, uint8_t Force4,
                         uint8_t Force5, uint8_t Force6, uint8_t Force7, uint8_t Force8, uint8_t Force9, uint8_t Force10, uint8_t Force11);
    void SetLeftTrigger(Trigger::TriggerMode triggerMode, uint8_t Force1, uint8_t Force2, uint8_t Force3, uint8_t Force4,
                        uint8_t Force5, uint8_t Force6, uint8_t Force7, uint8_t Force8, uint8_t Force9, uint8_t Force10, uint8_t Force11);
